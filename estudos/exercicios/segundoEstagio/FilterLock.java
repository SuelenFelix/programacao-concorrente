...
public class FilterLock implements Lock {
    ...
    public void lock() {
        ...
        for (int j = 1; j < n; j++) { // garante que existam n-1 niveis
            ...
            for (int k = 0; k < n; k++) {
                /*
                 * verica se existe um k, tal que o nível dele esteja acima ou igual ao id de
                 * me, além de garantir que exista uma outra vitima que não seja me
                 */
                while (k != me && nivel[k] >= nivel[me] && victim[j] == me) {
                    /*
                     * Esse bloco garante que o algortimo respeite os níveis, fazendo com que
                     * threads com nivel mais alto e que não são a vítima executem
                     * 
                     */
                }
